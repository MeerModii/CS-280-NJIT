...
//	same as this: 
// 	bool IsEqual(const Token & otherToken) const {
//   // Check if the token types and lexemes are the same
// 		return this->token == otherToken.token && this->lexeme == otherToken.lexeme;
// 	}
